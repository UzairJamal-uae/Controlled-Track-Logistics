          ...
          <div className="space-y-12">
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start space-x-6 group">
                ...
                <div>
                  <p className="text-[10px] text-gray-400 font-black uppercase tracking-widest mb-1">Owner & Founder</p>
                  <p className="text-xl font-black text-slate-900 group-hover:text-brand-accent transition-colors uppercase tracking-tight">{company.owner}</p>
                </div>
              </div>
            </div>
          </div>
