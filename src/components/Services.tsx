...
const services = [
  ...
  description:
    "We're expanding our services to provide complete freight brokerage solutions, connecting shippers with trusted carriers across the USA.",
  icon: ShieldCheck,
  color: "bg-brand/90",
  soon: true,
},
    ...
    <section className="py-24 bg-white" id="services">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <h3 className="text-4xl md:text-5xl font-black text-slate-900 mb-6 font-sans">Premium Truck Dispatch Services</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <motion.div
              ...
              className="group p-8 relative rounded-3xl border border-gray-100 bg-gray-50/50 hover:bg-white hover:text-slate-900 transition-all duration-500 hover:shadow-2xl hover:shadow-brand/10"
            >
  {service.soon && (
  <motion.span className="absolute top-5 right-5 rounded-full bg-brand text-white px-3 py-1 text-xs font-semibold shadow-lg">
    Coming Soon
  </motion.span>
)}
